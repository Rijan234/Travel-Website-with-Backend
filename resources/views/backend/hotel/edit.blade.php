        ...
        <div class="w-1/2 mx-auto">
            ...
            <form action="{{ route('hotel.update', $hotel->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-2">
                    ...
                    <div class="flex flex-wrap">
                        <div class="flex items-center me-4">
                            ...
                            <input id="green-radio" type="radio" value="available" name="lodging" class="w-4 ms-2 h-4 text-green-600 bg-gray-100 border-gray-300 focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"  {{ $hotel->lodge == 'available' ? 'checked' : '' }}  required >
                        </div>
                        <div class="flex items-center me-4">
                            <label for="red-radio" class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Not Available</label>
                            <input id="red-radio" type="radio" value="not-available" name="lodging" class="w-4 ms-2 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $hotel->lodge == 'not-available' ? 'checked' : '' }} required>
                        </div>
                ...
                <div class="mb-2">
                    ...
                    <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" name="hotel_photo" >
                ...
                <img src="{{ asset($hotel->hotel_photo) }}" alt="hotel photo" >
